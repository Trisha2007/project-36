...
function setup() {
   createCanvas(900, 900);
    ...
    viewFoodBtn=createButton(" Food Stock")
    ...
    viewScheduleBtn=createButton(" Vaccination Schedule")
...
if(lastFed>=12){
  ...
  if (currentTime===(lastFed+1)) {
        ...
        stroke("blue");
        strokeWeight("4");
        text("Playing",200,300)
  }else if(currentTime===(lastFed+2)){
        update("Sleeping");
        food.bedroom();
        textSize(30)
        text(" Sleeping",200,300)
